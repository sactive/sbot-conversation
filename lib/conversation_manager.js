...
class ConversationManager {
   ...
   * @param {String} receiverUserId - `userId&roomId` or userId.
   * @returns {Array} Returns all paused conversations messages.
   */
   ...
   * @param {String} receiverUserId - `userId&roomId` or userId.
   * @returns {Array} Returns the conversations of `receiverUserId`.
   */
   ...
   * @param {String} receiverUserId - `userId&roomId` or userId.
   * @returns {Object|Null} Returns current conversation.
   */
