...
class ConversationManager {
  ...
  resumeConversation(receiverUserId, conversationId) {
    ...
    if (!this._verifyPermission(receiverUserId, conversationId)) {
      return `Conversation: ${conversationId} is not created by user: ${receiverUserId}`;
    }
    this.pauseConversations(receiverUserId);
    ...
    return `Resume conversation : ${conversationId} successfully. \n**Last question:** ${lastQuestion} ${lastReply}`;
  }
  ...
  cancelConversation(receiverUserId, conversationId, options = {}) {
    ...
    if (!this._verifyPermission(receiverUserId, conversationId)) {
      return `Conversation: ${conversationId} is not created by user id: ${receiverUserId}.`;
    }
    ...
    return `Cancel conversation : ${conversationId} successfully. ${resumeRes}`;
  }
